...
{
    class gettoken : myservice<q_gettoken>
    {
        public async override Task<answer> getanswer(q_gettoken question)
        {
            var dddd = dbtoken.FindAll().ToArray();
